...
L.TileLayer.ChinaProvider.providers = {
  TianDiTu: {
    Normal: {
      Map: '//t{s}.tianditu.gov.cn/DataServer?T=vec_w&X={x}&Y={y}&L={z}&tk=b236915985285041b5376595899ed9fc',
      Annotion:
        '//t{s}.tianditu.gov.cn/DataServer?T=cva_w&X={x}&Y={y}&L={z}&tk=b236915985285041b5376595899ed9fc',
    },
    Satellite: {
      Map: '//t{s}.tianditu.gov.cn/DataServer?T=img_w&X={x}&Y={y}&L={z}&tk=b236915985285041b5376595899ed9fc',
      Annotion:
        '//t{s}.tianditu.gov.cn/DataServer?T=cia_w&X={x}&Y={y}&L={z}&tk=b236915985285041b5376595899ed9fc',
    },
    Terrain: {
      Map: '//t{s}.tianditu.gov.cn/DataServer?T=ter_w&X={x}&Y={y}&L={z}&tk=b236915985285041b5376595899ed9fc',
      Annotion:
        '//t{s}.tianditu.gov.cn/DataServer?T=cta_w&X={x}&Y={y}&L={z}&tk=b236915985285041b5376595899ed9fc',
    },
    Subdomains: ['0', '1', '2', '3', '4', '5', '6', '7'],
    key: 'b236915985285041b5376595899ed9fc',
  },
...
export default L.TileLayer.ChinaProvider.providers
