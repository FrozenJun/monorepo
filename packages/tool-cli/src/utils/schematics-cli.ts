...
function parseSchematicName(str: string | null): { collection: string; schematic: string | null } {
  ...
  let collection = 'tool-cli' // 默认值改为自己的包名
...
export async function main({
   ...
   */
  const parsedArgs = Object.assign({}, itemConfig, argv)
  delete parsedArgs['--']
  ...
  Reflect.deleteProperty(parsedArgs, '_')
